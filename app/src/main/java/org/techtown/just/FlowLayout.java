...
public class FlowLayout extends ViewGroup {
    ...
    private int leftPadding = 0; // the spacing between lines in flowlayout
    private int rightPadding = 0; // the spacing between lines in flowlayout
    private int topPadding = 0; // the spacing between lines in flowlayout
    private int bottomPadding = 0; // the spacing between lines in flowlayout
    ...
    public FlowLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        leftPadding = mTypedArray.getDimensionPixelSize(
                R.styleable.FlowLayout_child_leftpadding, 0);
        rightPadding = mTypedArray.getDimensionPixelSize(
                R.styleable.FlowLayout_child_leftpadding, 0);
        topPadding = mTypedArray.getDimensionPixelSize(
                R.styleable.FlowLayout_child_toppadding, 0);
        bottomPadding = mTypedArray.getDimensionPixelSize(
                R.styleable.FlowLayout_child_toppadding, 0);
        mTypedArray.recycle();
    }
